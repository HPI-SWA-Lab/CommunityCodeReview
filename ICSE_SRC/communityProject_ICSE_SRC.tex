...
%
Social coding sites like GitHub\footnote{https://github.com} and BitBucket\footnote{https://bitbucket.org} enables substantially more collaborations among developers \cite{thung2013github} and shift the focus of interaction to individual contributors and their activities with electronic artifacts~\cite{dabbish2012social}.
%
...
%
While these pull requests usually are done using a social coding website~\cite{dabbish2012social, thung2013github}, our concept allows the developers to stay inside their IDE and avoid context switches. 
%
...
%
The tools CodeFlow~\cite{bird2015CodeReviewPlatform}, Mondrian~\cite{kennedy2006Mondrian}, Gerrit~\cite{google2016gerrit} and Phabricator~\cite{tsotsis2011Phabricator} providing the ability to focus on code reviews. 
%
But Developers have to leave their IDE to create or review code changes. 
%
