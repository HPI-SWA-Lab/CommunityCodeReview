...
%
Studies confirmed, that review coverage and participation have a significant impact on code quality and the correctness of software~\cite{ackerman1989software, mcintosh2014impact, fagan2001design}. 
%
...
%
Reviews forms range from very informal (e.g. pair programming~\cite{beck2000extreme}) to very formal (e.g. software inspections~\cite{fagan2001design}). 
%
Convergent peer reviews are lightweight, flexible processes, that happen early, quickly and frequently~\cite{rigby2013PeerCodeReviews}. 
%
...
%
Therefore the purpose of reviews change from defect finding to discussions about alternative solutions and long-term code maintainability~\cite{rigby2013PeerCodeReviews, czerwonka2015codereviews}.
