...
%
\todo[inline]{provide good examples to new developers}
...
%
This approach lowers the barrier to comment on source code and increases the amount of feedback\todo{prove claim}.
%
